[{if $oView->isEasyCreditPermitted() }]
                            ...
                            <div class="panel-body">
                                [{if !$oView->hasSalutation()}]
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <select name="ecred[oxuser__oxsal]" class="form-control selectpicker">
                                                <option value="" selected>-</option>
                                                <option value="MRS">[{oxmultilang ident="MRS"}]</option>
                                                <option value="MR">[{oxmultilang ident="MR" }]</option>
                                            </select>
                                        </div>
                                    </div>
                                [{/if}]

                                [{if !$oView->hasBirthday()}]
                                    <div class="form-group oxDate[{if $aErrors.oxuser__oxbirthdate}] text-danger[{/if}]">
                                        <label class="control-label col-xs-12 col-lg-3">[{oxmultilang ident="BIRTHDATE"}]</label>
                                        <div class="col-xs-3 col-lg-3">
                                            <input id="oxDay" class="oxDay form-control" name="ecred[oxuser__oxbirthdate][day]" type="text" maxlength="2" value="" placeholder="[{oxmultilang ident="DAY"}]">
                                        </div>
                                        <div class="col-xs-6 col-lg-3">
                                            <select class="oxMonth form-control selectpicker" name="ecred[oxuser__oxbirthdate][month]">
                                        ...
                                        <div class="col-xs-3 col-lg-3">
                                            <input id="oxYear" class="oxYear form-control" name="ecred[oxuser__oxbirthdate][year]" type="text" maxlength="4" value="" placeholder="[{oxmultilang ident="YEAR"}]">
                                        </div>
