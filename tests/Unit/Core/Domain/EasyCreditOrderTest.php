...
class EasyCreditOrderTest extends TestCase
{
    ...
    public function testFinalizeOrderWithStorageNotInitializing(): void
    {
        ...
        $dicSession->set('paymentid', EasyCreditHelper::EASYCREDIT_INSTALLMENT_PAYMENTID);
        ...
        $oxOrder = $this->getMockBuilder(EasyCreditOrder::class)->disableOriginalConstructor()->setMethods(['getDic'])->getMock();
    ...
    public function testFinalizeOrderWithStorageInitialized(): void
    {
        ...
        $oxOrder = $this->getMockBuilder(EasyCreditOrder::class)
            ->disableOriginalConstructor()
            ->setMethods([
                'getDic',
                'validatePayment',
